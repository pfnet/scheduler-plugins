...
func (f *MockFrameworkHandle) NominatedPodsForNode(nodeName string) []fwk.PodInfo { return nil }
...
func (f *MockFrameworkHandle) RunPreFilterExtensionAddPod(ctx context.Context, state fwk.CycleState, podToSchedule *v1.Pod, podInfoToAdd fwk.PodInfo, nodeInfo fwk.NodeInfo) *fwk.Status {
	return nil
}
func (f *MockFrameworkHandle) RunPreFilterExtensionRemovePod(ctx context.Context, state fwk.CycleState, podToSchedule *v1.Pod, podInfoToRemove fwk.PodInfo, nodeInfo fwk.NodeInfo) *fwk.Status {
	return nil
}
